...
\def\thesistitle{Classification of cancer pathology records with Deep
...
\include{conclusions}
\appendix{
  \include{appendix1}  % Optional, for details that cannot fit the main body
  \include{publications} % Mandatory
}
% End EDIT
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
